...
namespace TowerDefense
{
    public class Abilities : SingletonBase<Abilities>
    {
        ...
        public class FireAbility : Usable
        {
            ...
            [SerializeField] private Sound m_fireAbilitySound = Sound.FireAbility;
            [SerializeField] private GameObject m_ringEffectPrefab;
            ...
            public void SetUpgrade()
            {
                if (Upgrades.Instance)
                {
                    ...
                    if (level > 1) m_damage += (int)(m_upgradeModifier * level);
                    ...
                    m_targetingCircle.gameObject.SetActive(false);
                }
            }
            ...
            public void Use()
            {
                ...
                m_targetingCircle.gameObject.SetActive(true);
                ...
                ClickProtection.Instance.Activate((Vector2 v) =>
                {
                    ...
                    var effect = Instantiate(m_ringEffectPrefab, position, Quaternion.identity);
                    Destroy(effect, 1.0f);
        ...
        public class SlowAbility : Usable
        {
            ...
            public void SetUpgrade()
            {
                if (Upgrades.Instance)
                {
                    ...
                    if (level > 1) m_duration += m_upgradeModifier * level;
